...
before_action :authenticate_user!
  ...
  def data
    ...
    render(json: @layers, include: [{strat_column: {except: [:created_at, :updated_at]}},{lithology: {except: [:created_at, :updated_at]}}, {timescale: {only: [:interval_name, :color, :abbrev]}}, {contact: {except: [:created_at, :updated_at]}}] )
