...
{name:"Interbedded shale and silty limestone (shale dominant)", name2: "", name3: "", rock_type: "Sedimentary", classification:"Mudrock", url: "#sed672" },
{name:"Interbedded shale and limestone (shale dominant)", name2: "", name3: "", rock_type: "Sedimentary", classification:"Mudrock", url: "#sed673" },
{name:"Interbedded shale and limestone (shale dominant)", name2: "", name3: "", rock_type: "Sedimentary", classification:"Mudrock", url: "#sed674" },
{name:"Interbedded calcareous shale and limestone (shale dominant)", name2: "", name3: "", rock_type: "Sedimentary", classification:"Mudrock", url: "#sed675" },
{name:"Interbedded silty limestone and shale", name2: "", name3: "", rock_type: "Sedimentary", classification:"Carbonate", url: "#sed676" },
{name:"Interbedded limestone and shale", name2: "", name3: "", rock_type: "Sedimentary", classification:"Carbonate", url: "#sed677" },
{name:"Interbedded limestone and shale", name2: "", name3: "", rock_type: "Sedimentary", classification:"Carbonate", url: "#sed678" },
{name:"Interbedded limestone and shale (limestone dominant)", name2: "", name3: "", rock_type: "Sedimentary", classification:"Carbonate", url: "#sed679" },
{name:"Interbedded limestone and calcareous shale", name2: "", name3: "", rock_type: "Sedimentary", classification:"Carbonate", url: "#sed680" },
